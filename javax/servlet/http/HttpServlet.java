...
/* 556 */       allow = "GET";
/* 557 */     if (ALLOW_HEAD)
/* 558 */       if (allow == null) allow = "HEAD"; else
/* 559 */         allow = allow + ", HEAD";
/* 560 */     if (ALLOW_POST)
/* 561 */       if (allow == null) allow = "POST"; else
/* 562 */         allow = allow + ", POST";
/* 563 */     if (ALLOW_PUT)
/* 564 */       if (allow == null) allow = "PUT"; else
/* 565 */         allow = allow + ", PUT";
/* 566 */     if (ALLOW_DELETE)
/* 567 */       if (allow == null) allow = "DELETE"; else
/* 568 */         allow = allow + ", DELETE";
/* 569 */     if (ALLOW_TRACE)
/* 570 */       if (allow == null) allow = "TRACE"; else
/* 571 */         allow = allow + ", TRACE";
/* 572 */     if (ALLOW_OPTIONS) {
/* 573 */       if (allow == null) allow = "OPTIONS"; else
/* 574 */         allow = allow + ", OPTIONS";
/*     */     }
...
/* 617 */       String headerName = (String)reqHeaderEnum.nextElement();
...
/* Location:              C:\Users\emorajv\Downloads\javax.servlet-api-3.0.1.jar!\javax\servlet\http\HttpServlet.class
